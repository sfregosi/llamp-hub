...
```{r ss-ghi-pp, echo = FALSE, out.width = '65%', fig.align = 'center', fig.cap = 'Screenshot showing the new issue chooser on GitHub'}
...
```{r ss-ghi-a, echo = FALSE, out.width = '65%', fig.align = 'center', fig.cap = 'Screenshot showing the new issue chooser on GitHub'}
knitr::include_graphics('images/screenshot_github_post-processing-template.png')
```
