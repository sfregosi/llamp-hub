...
- Transcribe underwater and in-air datasheets to .xlsx
  ...
  `LL000_Summary_phase3_template.xlsx` or in the llamp repository at [LL000_Summary_phase3template.xlsx](https://github.com/sfregosi/llamp/blob/main/docs/files/LL000_Summmary_phase3template.xlsx){target='_blank'}
