...
- Manually scan LTSAs to mark start/stop time of odontocete acoustic events 
  - Use Triton to scan full deployment. Latest version: [MarineBioAcousticsRC/Triton](https://github.com/MarineBioAcousticsRC/Triton)
  - Manual picks can be made using Triton Logger, or just manually noted in a table
  - Create a new table/log for each recorder in a given trip (e.g., `log_LL060_FR38_DL65.xls`)
...
- Run Pamguard detector suite - click, whistle, burst pulse
  - Use `pam20207b_llharp_banter.psfx` [download here](https://github.com/sfregosi/llamp/blob/main/pamguard/settings/pam20207b_llharp_banter.psfx)
  - Detail on how this preferences file was built can be found in the [glider-MHI repo](https://github.com/sfregosi/glider-MHI/blob/main/docs/_site/pg_settings.html) or talk to JLKM for more info! 
